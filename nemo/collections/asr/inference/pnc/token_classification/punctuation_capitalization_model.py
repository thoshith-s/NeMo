...
from nemo.collections.asr.inference.pnc.token_classification.punctuation_capitalization_config import (
    legacy_model_config_to_new_model_config,
)
from nemo.collections.asr.inference.pnc.token_classification.punctuation_capitalization_infer_dataset import (
...
class PunctuationCapitalizationModel(NLPModel):
    """
